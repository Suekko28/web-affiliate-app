                ...
                <div class="card w-full px-4 lg:w-1/2 xl:w-1/3">
                    <div class="card-body">
                        <div class=" overflow-hidden mb-10">
                            <a href="">
                                <img src="{{ asset('' . $itemProduct->image) }}" alt="Logo OGI" class="w-full object-cover h-[395]">
                            </a>
                            <div class="py-8 px-6">
                                <h6 class="code-product mb-2">{{$item->tag_product}}</h6>
                                <h4 class="title-product mb-2">{{$itemProduct->nama}}</h4>
                                <div class="flex flex-row space-x-6">
                                    <a href="{{$itemProduct->link_shopee}}" target="_blank" class="rounded hover:bg-slate-200">
                                        <img src="{{ asset('/img/shopee.svg') }}" alt="">
                                    </a>
                                    <a href="{{$itemProduct->link_tokped}}" class="rounded hover:bg-slate-200">
                                        <img src="{{ asset('/img/tokopedia.svg') }}" alt="">
                                    </a>
                                    <a href="{{$itemProduct->link_tiktok}}" class="rounded hover:bg-slate-200">
